...
// Status bar + content + gesture nav, repaletted to Rinig (warm paper + ink +
// Beam). No dependencies, no image assets.
//
//   <AndroidDevice dark={isLiveStage}>
//     ...your screen content...
//   </AndroidDevice>

// Repalette to Rinig (warm paper + ink + Beam).
const MD_C = {
  surface: '#fbf8f2',
  surfaceVariant: '#d8d0c2',
  inverseOnSurface: '#ece6da',
  secondaryContainer: '#ffedc2',
  primaryFixedDim: '#ffb81c',
  onSurface: '#14110c',
  onSurfaceVar: '#6b6150',
  onPrimaryContainer: '#14110c',
  primary: '#14110c',
  frameBorder: 'rgba(20,17,12,0.32)',
}
...
export function AndroidDevice({ children, width = 412, height = 892, dark = false }) {
  return (
    <div style={{
      width, height, maxWidth: '100%', maxHeight: '100dvh',
      borderRadius: 18, overflow: 'hidden',
      background: dark ? '#0a0908' : MD_C.surface,
